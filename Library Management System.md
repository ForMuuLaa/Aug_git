...
The LibrarySystem class is a fully functional application designed to handle various library operations. It stores books, users, and authors as separate lists, providing methods to manage these entities through different actions:
